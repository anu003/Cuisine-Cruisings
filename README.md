...
Using Python, BeautifulSoup, Selenium and AWS EC2, I web scraped the recipe databanks from the [data scources](https://github.com/prathi019/Cuisine-Cruisings/tree/master#data-sources) to collect raw text, lists, and other information from html.
